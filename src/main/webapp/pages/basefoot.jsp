...
<div class="footer">
    <div class="width1190">
        <!-- FIXME 这里把各个连接更换-->
        <div class="fl"><a href="/index.jsp" target="_blank"><strong>易居平台</strong></a><a href="#">关于我们</a><a href="#">联系我们</a><a
                href="#" target="_blank">个人中心</a></div>
        <div class="fr">
            <dl>
                <!-- FIXME 这里把图片更换-->
...
<div class="copy">Copyright@　2019　易居住房交易平台　　鄂ICP备19009914号-1&nbsp;&nbsp;&nbsp;&nbsp;技术支持：<a target="_blank" href="#">中软国际</a>
</div>
