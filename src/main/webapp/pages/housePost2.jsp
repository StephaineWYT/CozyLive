                ...
                <div class="register-box-con2">
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseNature" placeholder="如：商品房、住宅房等" id="house_natuer"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseModel" placeholder="如：普通住宅、公寓式住宅、别墅等" id="house_model"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseYear" placeholder="如：2008、2019等" id="house_year"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseValid" placeholder="如：70年、80年、永久等" id="house_valid"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseLayout" placeholder="如：2厅4室2卫等" id="house_layout"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseArea" placeholder="如：100、85等。单位：m²" id="house_narea"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseTurn" placeholder="如：南北、西南等" id="house_turn"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseFloor" placeholder="如：6、8、9等" id="house_floor"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="floorAll" placeholder="如：7、13、16等" id="floor_all"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseDecorate" placeholder="如：精装修、简装修等" id="house_decorate"/>
                        </div>
                    </div>
                    ...
                    <div class="register-box-con2-box clearfix mar-bottom20">
                        ...
                        <div class="register-box-con2-box-right">
                            <input type="text" class="login-box-cen-form-input w358" name="houseLift" placeholder="如：是、否等" id="house_lift"/>
                        </div>
                    </div>
                    <%--下一步按钮--%>
